...
public class Game {
	...
	private static Pokemon chooseFirstPokemon() {
		...
		switch (choice) {
		case 1:
			PokemonData CharmanderData = PokemonData.CHARMANDER;
			chosenPokemon = new Pokemon(CharmanderData);
		...
		case 2:
			PokemonData BulbasaurData = PokemonData.BULBASAUR;
			chosenPokemon = new Pokemon(BulbasaurData);
			chosenPokemon.setLevel(5);
		...
		case 3:
			PokemonData SquirtleData = PokemonData.SQUIRTLE;
			chosenPokemon = new Pokemon(SquirtleData);
			chosenPokemon.setLevel(5);
